...
| T018 | Create UserRepository | Create JPA repository for User entity | T017 | 🟢 Completed | AGENT |
| T019 | Create JWT Utility | Create JwtUtil class for token generation and validation | T013 | 🟢 Completed | AGENT |
